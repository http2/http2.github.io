...
2. [draft-06](http://tools.ietf.org/html/draft-ietf-httpbis-http2-06) - references [HPACK-02](http://tools.ietf.org/html/draft-ietf-httpbis-header-compression-02) (**current**, interop in [Seattle](https://github.com/http2/wg_materials/tree/master/interim-13-10))

See also the [third implementation draft milestone](https://github.com/http2/http2-spec/issues?milestone=3&state=open) for upcoming issues.
